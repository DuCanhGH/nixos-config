...
* [meowkatee](https://gitgud.io/meowkatee) and [nyakase](https://github.com/nyakase) for suggesting the use of `LD_PRELOAD` [on a merge request for AUR packages](https://gitgud.io/wackyideas/aerothemeplasma/-/merge_requests/11#note_1759476)
